          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              },
              {
                ...
                type: 'whatsapp',
                link: 'https://chat.whatsapp.com/F8hW6i1OuZL777j6yMRe96?mode=wwc',
              },
              {
              ...
              <motion.div
                ...
                className="group"
              >
                {/* Make the entire card clickable for WhatsApp */}
                {item.type === 'whatsapp' ? (
                  <a
                    href={item.link}
                    target="_blank"
                  ...
                  >
                    <motion.div
                      ...
                      className="premium-card p-8 rounded-2xl glassmorphism hover:bg-card/90 hover:border-[#00A19A]/30 text-center h-full will-change-transform relative overflow-hidden cursor-pointer"
                    >
                      {/* Background Gradient */}
                      <div
                  ...
                  // Regular non-clickable cards for Email and Social
                  <motion.div
                    whileHover={{ y: -12, scale: 1.03 }}
