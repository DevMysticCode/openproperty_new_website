    ...
    >
      <div className="relative w-full max-w-8xl mx-auto px-6 sm:px-8">
        ...
        <motion.div
          ...
          className="space-y-24 mt-48 hero-subtext bg-gradient-paragraph-light max-w-7xl mx-auto bg-clip-text bg-no-repeat pb-1  leading-tight -tracking-4 text-transparent bg-gradient-paragraph-light pb-32 last:mb-32 last:pb-0 md:pb-52 last:md:mb-52 text-left"
        >
