      ...
      <div className="min-h-screen bg-background">
        ...
        >
          ...
          <motion.div
            ...
            className="relative flex items-center justify-center w-full height-[100vh]"
          >
            <ChipsScene
              ...
              <div className="px-6 pb-20 md:grid-cols-2 md:gap-x-5 text-2xl text-black md:gap-y-24 md:px-[12%] md:pb-44">
                ...
                >
                  ...
                  >
                    ...
                    dragged deep into the conveyancing process, simply because
                    the sector lacks connectivity and transparency.
                  </p>
                  <p
                  ...
                  >
                    ...
                    conveyancers, and consumers alike find themselves
                    shouldering tasks that were never truly theirs to begin
                    with. And while professionals struggle with inefficiency,
                    it’s the consumer who suffers the most. What should be the
                    happiest milestone in their lives — getting the keys to a
                    new home — far too often unravels into a stressful,
                    confusing, and anxiety-inducing nightmare.
                  </p>
                  <p
                    className="italic text-center leading-relaxed mt-12"
                    // style={{
                  ...
                  >
                    ...
                    transactions could look like. Not just a slight improvement
                    to the old system — but a reinvention of the journey itself:
                    one where transparency, simplicity and connection replace
        ...
        >
          ...
          <motion.div
            initial={{ opacity: 0, y: 100 }}
            animate={
              isWhyInView ? { opacity: 1, y: 0 } : { opacity: 0, y: 100 }
            }
        ...
        >
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-6 sm:px-8">
            ...
            <div
              ...
              style={{
                background:
                  'linear-gradient(135deg, #00A19A, #1e6864, #000000)',
                WebkitBackgroundClip: 'text',
                WebkitTextFillColor: 'transparent',
                backgroundClip: 'text',
              }}
            >
              <p className="text-black leading-relaxed font-light mb-6">
                The team welcome investment proposals from founders, companies
                or organisations in the PropTech/FinTech/EdTech space.
              </p>

              <p className="text-black leading-relaxed font-light mb-6">
                Sign up to our mailing list to receive our monthly newsletters,
                featuring the latest developments in umovingu's flagship
                product.
              </p>
            </div>
